...
<div class="cssmenu">
 ...
 <br><br><br>
		<form action="makeappointmentPath" method="get">
			<div
				style="background-color: #091927; height: 400px; width: 400px; border-radius: 30px; text-align: center;"
				class="col-md-offset-4">
				<h1 style="text-align: center; padding-top: 30px; color: #ffffff;">Make
				Appointment</h1>

				<div class="col-sm-12" style="padding-top: 10px;">
					<input type="text" class="form-control" id="id"
						placeholder="Owner Id" name="ownerid" style="border-radius: 15px;" required="required">
				</div>
				<div class="col-sm-12" style="padding-top: 10px;">
					<input type="text" class="form-control" id="firstname"
						placeholder="AppointmentID" name="appid" style="border-radius: 15px;"  required="required">
				</div>
				<div class="col-sm-12" style="padding-top: 10px;">
				...
				<div class="col-sm-12" style="padding-top: 10px;">
					<input type="time" class="form-control" id="firstname"
						placeholder="Appointment Time" name="time"
						style="border-radius: 15px;"  required="required">
				</div>
